...
using Petstore.OpenApi;
using Petstore.Formatters;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.SwaggerDoc("1.0.12", new OpenApiInfo
                    {
                        Title = "Swagger Petstore - OpenAPI 3.1",
                        Description = "Swagger Petstore - OpenAPI 3.1 (ASP.NET Core 8.0)",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/1.0.12/openapi.json", "Swagger Petstore - OpenAPI 3.1");
