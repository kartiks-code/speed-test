...
[PIT](https://pitest.org) (`info.solidsoft.pitest` 1.19.0, Gradle 9 compatible, `pitestVersion = '1.22.1'` for Java 25/ASM 9.9.1 support) is configured in `build.gradle`.
