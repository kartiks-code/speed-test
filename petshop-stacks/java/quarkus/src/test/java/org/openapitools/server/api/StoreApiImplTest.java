...
/**
 * Unit tests for {@link StoreApiImpl}, verifying delegation to the order and pet
...
class StoreApiImplTest {
    ...
    void getInventoryDelegatesToPetRepository() {
        ...
        assertSame(inventory, resource.getInventory());
    ...
    void getOrderByIdReturnsRepositoryResult() {
        ...
        assertSame(order, resource.getOrderById(4L));
    ...
    void getOrderByIdPropagatesNotFound() {
        ...
        WebApplicationException ex = assertThrows(WebApplicationException.class, () -> resource.getOrderById(99L));
    ...
    void placeOrderDelegatesToOrderRepository() {
        ...
        assertSame(stored, resource.placeOrder(order));
